...
// Same design as the cmoda7_35t target, with the UART brought out to the Pmod
// JA header instead of the board's FTDI USB bridge, for talking to a
// microcontroller or other external 3.3V device rather than to a host PC. The
// ports are named uart_rxd/uart_txd rather than the sibling target's
// RsRx/RsTx as a reminder that these are not the USB-UART pins.
//
